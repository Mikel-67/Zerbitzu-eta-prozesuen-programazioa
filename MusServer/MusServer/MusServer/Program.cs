    ...
    namespace Zerbitzaria
    {
        public class Zerbitzaria
        {
            ...
            private static Partida CrearPartida(string codigo = null, bool ochoReyes = false)
            {
                lock (partidasLock)
                {
        ...
        public static List<string> KartakSortu(bool ochoReyes)
        {
            ...
            foreach (var palo in paloak)
            {
                ...
                {
                    string valorFinal = balio;

                    if (ochoReyes)
                    {
                        Console.WriteLine("8 Errege aukeratu du");
                        if (balio == "3") valorFinal = "12"; 
                        else if (balio == "2") valorFinal = "1";
                    }

                    kartak.Add($"{palo}{valorFinal}");
                }
            }
